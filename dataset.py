...
class BiDataset(Dataset):
    ...
    def __getitem__(self, index):
        src_tgt_pair = self.dataset[index]['translation']
        src_sentence = src_tgt_pair[self.src_lang]
        tgt_sentence = src_tgt_pair[self.tgt_lang]
        ...
        # equivalent to torch.rnn.utils.pad_sequence
        ...
        return {"encoder_input":encoder_input, #Seq len
                ...
                "tgt_sentence" : tgt_sentence # (1, 1, seq_len)
                }
